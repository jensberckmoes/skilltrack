...
public final class TestConstants {
    ...
    public static final class Tokens {
        ...
        public static final LocalDate STATIC_NOW = LocalDate.of(2026, 1, 30);
        public static final Token VALID_TOKEN = Token.of(TokenValue.of(VALID_RAW_TOKEN).value(), LocalDate.of(2027, 1, 30).plusDays(1));
        public static final Map<TokenValue, Token> TEST_TOKENS = Map.ofEntries(
                Map.entry(TokenValue.of(VALID_RAW_TOKEN), VALID_TOKEN),
                Map.entry(TokenValue.of(EXPIRED_TOKEN), Token.of(TokenValue.of(EXPIRED_TOKEN).value(), LocalDate.of(2027, 1, 30).minusYears(10))));
