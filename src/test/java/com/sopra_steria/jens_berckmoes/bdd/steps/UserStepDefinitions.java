...
public class UserStepDefinitions {
    ...
    public void theResponseShouldContainAllUsers() {
        ...
        assertThat(users.getBody()
                .getUserResponses()).containsExactlyInAnyOrder(GET_USER_RESPONSES_AS_SET.toArray(new GetUserResponse[0]));
    }
    ...
    public void theResponseContainsTheUserDetails() {
        ...
        assertThat(user.getBody().username()).isEqualTo("alice@example.com");
    }
